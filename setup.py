...
setup(
    name='topology_lib_echo',
    version=find_version('lib/topology_lib_echo/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_echo/tree/master/doc',
    keywords='topology_lib_echo',
    ...
    entry_points={
        'topology_library_10': [
            'echo = topology_lib_echo.library'
        ]
    }
)
